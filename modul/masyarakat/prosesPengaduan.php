...
if(!$suksesTambahData AND !$suksesUpload){ echo mysqli_error($conn); } else { echo '<script>alert("pengaduan sudah diajukan");window.location.href="http://'.$server.'modul/masyarakat/pengaduan.php"</script>'; }